...
public abstract class StackItem{
    ...
    /**
     * Indica si este objeto puede entrar a la torre en su estado actual.
     * Por defecto, cualquier item puede entrar.
     * @param items elementos actuales de la torre.
    ...
    /**
     * Indica si este objeto puede ser removido de la torre.
     * Por defecto, cualquier item puede salir.
     * @param items elementos actuales de la torre.
    ...
    /**
     * Permite ejecutar comportamiento especial justo antes de insertar
     * el objeto en la torre. Por defecto no hace nada.
     * @param items elementos actuales de la torre.
     */
    ...
    /**
     * Devuelve el subtipo del elemento.
     * Por defecto, todos los elementos actuales son normales.
     * @return subtipo del elemento.
     */
    ...
    /**
     * Devuelve la posición donde el objeto debe insertarse en la torre.
     * Por defecto, cualquier item entra al final de la lista.
     * @param items elementos actuales de la torre.
     * @return índice de inserción del objeto.
     */
